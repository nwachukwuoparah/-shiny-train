...
export default function careWork(props) {
  ...
  return (
    <div className='careWork'>
      <Image image={Home_Monitoring} />
      <div className='careWork_bnx1'>
        <div className='careWork_bnx1_text'>
          <p>
