...
import './health-and-wellbeing.css'
...
export default function Health_and_wellbeing(props) {
  ...
  return (
    <div className='health-and-wellbeing'>
      <Image image={Home_Monitoring} text="Health and wellbeing" />
      <div className='health-and-wellbeing_text' >
        <div className='health-and-wellbeing_text_wrap'>
          {item.map((i) => (
            <TheamCard {...i} />
          ))}
        </div>
      ...
      <div className='health-and-wellbeing_contact'>
        <Contact_card arr={[1,2]} />
      </div>

      <div className='health-and-wellbeing_nav'>
