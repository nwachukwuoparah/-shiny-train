...
import './preventing-falls-in-the-elderly.css'
...
export default function preventing_falls(props) {
  ...
  return (
    <div className='preventing-falls-in-the-elderly'>
      <Image image={Home_Monitoring} text="Preventing a fall" />
      <div className='preventing-falls-in-the-elderly_text' >
        {item.map((i) => (
          <TheamCard {...i} />
        ))}
      </div>
