...
import './understanding-home-care.css'
...
export default function Understanding_home_care(props) {
  ...
  return (
    <div className='understanding-home-care'>
      <Image image={Home_Monitoring} text="Understanding and preparing for home care" />
      <div className='understanding-home-care_text' >
        {item.map((i) => (
          <TheamCard {...i} />
        ))}
      </div>
      <div className='understanding-home-care_nav'>
