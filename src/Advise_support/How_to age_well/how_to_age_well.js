...
export default function Age_well(props) {
  ...
  return (
    <div className='how_to_age_well'>
      <Image image={Home_Monitoring} text="Elderly care & how to age well" />
      <div className='how_to_age_well_text' >
        {item.map((i) => (
          <TheamCard {...i} />
        ))}
      </div>
      <div className='how_to_age_well_nav'>
