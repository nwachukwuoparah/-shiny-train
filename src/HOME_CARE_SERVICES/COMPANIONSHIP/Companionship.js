...
export default function Companionship(props) {
  ...
  return (
    <div className='Companionship'>
      <Image image={Home_Monitoring} />
      <div className='Companionship_bnx1'>
        <div className='Companionship_bnx2'>
          {item.map((i) => (
            <TheamCard {...i} />
          ))}
        </div>
      ...
      <div className='Companionship_bnx3'>
        {[1, 2].map((i) => (
